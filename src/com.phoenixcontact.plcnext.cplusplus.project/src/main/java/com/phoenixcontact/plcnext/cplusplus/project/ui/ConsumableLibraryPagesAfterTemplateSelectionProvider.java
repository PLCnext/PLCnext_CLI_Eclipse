...
public class ConsumableLibraryPagesAfterTemplateSelectionProvider implements IPagesAfterTemplateSelectionProvider {
...
IWizardDataPage[] pages;
	...
	public IWizardDataPage[] createAdditionalPages(IWorkbenchWizard wizard, IWorkbench workbench,
		...
		pages[0] = new ProjectPropertiesWizardDataPage(ProjectType.CONSUMABLELIBRARY);
